    ...
    >
      ...
      <section className="pt-20 py-32 bg-gray-100 w-full min-h-[90vh]">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-600 text-lg mb-8 text-center max-w-3xl">
              Discover the beauty of our wildlife reserve through our
              interactive map.
            </p>{" "}
            <div
              id="map"
              className="w-full h-[600px] rounded-lg overflow-hidden shadow-xl relative"
              style={{ zIndex: 0 }}
            ></div>
          </div>
        </div>
        ...
        <div className="mt-16 container mx-auto px-4 max-w-7xl">
          <div className="flex flex-col items-center">
            <h3 className="text-green-600 uppercase tracking-wide text-lg font-semibold mb-4">
              AR View of Orangutan Feeding Area
            </h3>
            <iframe
