...
const VisitorLandingPage = () => {
    ...
    useEffect(() => {
        // For now, just render the page without authentication
        console.log("Visitor page loaded");
    }, []);
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-white p-10 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                            ...
                            <p className="text-gray-600 text-center mb-5">
                                Comprehensive learning materials to enhance your
                                knowledge about the park and its ecosystem.
                            </p>{" "}
                            <div className="text-center">
                                <a
                                    onClick={() =>
                                        navigate("/visitor/training")
                                    }
                        ...
                        <div className="bg-white p-10 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                            ...
                            <p className="text-gray-600 text-center mb-5">
                                Earn official certifications to validate your
                                expertise as a park guide.
                            </p>{" "}
                            <div className="text-center">
                                <a
                                    onClick={() =>
                                        navigate("/visitor/certification")
                                    }
                                    className="text-emerald-600 hover:text-emerald-800 font-medium inline-flex items-center cursor-pointer transition-colors"
                                >
                                    Learn More
                        ...
                        <div className="bg-white p-10 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                            ...
                            <p className="text-gray-600 text-center mb-5">
                                Access detailed information about the flora and
                                fauna within the park.
                            </p>{" "}
                            <div className="text-center">
                                <a
                                    onClick={() =>
                                        navigate("/visitor/plant-info")
                                    }
                                    className="text-emerald-600 hover:text-emerald-800 font-medium inline-flex items-center cursor-pointer transition-colors"
                                >
                                    Learn More
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-14">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto text-base md:text-lg">
                            Hear from park guides who have experienced our
                            training program
                        </p>
                    </div>
