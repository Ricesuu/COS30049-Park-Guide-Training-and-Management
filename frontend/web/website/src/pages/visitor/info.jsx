      ...
      <section className="pt-20 py-32 bg-gray-100 w-full min-h-[90vh]">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="flex flex-col items-center">
            <h3 className="text-green-600 uppercase tracking-wide text-lg font-semibold mb-2">Plant Information</h3>
            <h1 className="text-3xl md:text-4xl font-bold mb-4 text-center max-w-4xl">Discover Our Flora Collection</h1>
            <p className="text-gray-600 text-lg mb-16 text-center max-w-3xl">
              Learn about the diverse plant species in our reserve and their unique characteristics
            </p>            {loading ? (
              <div className="text-center text-gray-600">Loading plant information...</div>
            ) : error ? (
                  ...
                  >
                    ...
                    <div className="md:w-1/2 space-y-6">
                      <dl className="space-y-4">
                        <div>
                          <dt className="text-gray-900 font-bold mb-1">Common Name:</dt>
                          <dd className="text-gray-700">{plant.common_name}</dd>
                        </div>
                        <div>
                          <dt className="text-gray-900 font-bold mb-1">Scientific Name:</dt>
                          <dd className="text-gray-700 italic">{plant.scientific_name}</dd>
                        </div>
                        <div>
                          <dt className="text-gray-900 font-bold mb-1">Family:</dt>
