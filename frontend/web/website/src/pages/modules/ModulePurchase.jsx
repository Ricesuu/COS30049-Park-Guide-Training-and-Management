      ...
      try {
        ...
        try {
          ...
          statusResponse = await fetch(
            `${API_URL}/api/training-modules/${moduleId}/purchase-status`,
            {
              headers: {
  ...
  const handleConfirmedPayment = async () => {
    ...
    try {
      ...
      console.log("Creating form data with:", {
        uid: user.uid,
        user_id: userId,
        paymentPurpose: `Module Purchase: ${module.module_name || module.name}`,
      ...
      if (
        ...
        try {
          enrollResponse = await fetch(
            `${API_URL}/api/training-modules/${moduleId}/enroll`,
            {
              method: "POST",
              headers: {
                Authorization: `Bearer ${token}`,
        ...
        try {
          ...
          paymentFormData.append("transaction_date", new Date().toISOString());
          ...
          console.log("Payment processed successfully:", paymentResult); // Generate transaction details for the receipt
          setTransactionDetails({
      ...
      <div className="payment-main-content">
        <div className="payment-container">
          ...
          <p className="loading-message">
            Please wait while we fetch your module details. This might take a
            few seconds.
          </p>
        </div>
      </div>
      ...
      <div className="payment-main-content">
        <div className="payment-container">
          ...
          <div className="error-container">
            ...
            <p>
              The requested module could not be found. It may have been removed
    ...
    return (
      <div className="payment-main-content">
        <div className="payment-container">
          ...
          <p>
            You have already enrolled in {module.module_name || module.name}.
          </p>
    ...
    return (
      <div className="payment-main-content">
        <div className="payment-container">
          ...
          <p>
            Your payment for {module.module_name || module.name} is being
    ...
    return (
      <div className="payment-main-content">
        <div className="payment-container">
          ...
          <p>
            Your previous payment for {module.module_name || module.name} was
            rejected. Please try again.
          </p>
          <button onClick={() => setShowForm(true)} className="pay-button">
            Try Again
          </button>
        </div>
      </div>
        ...
        <div className="modal-overlay">
          <div className="modal-container receipt">
            ...
            <div className="receipt-body">
              ...
              {transactionDetails.cardLast4 && (
                <div className="receipt-item">
                  ...
                  <span>
                    Credit Card (ending in {transactionDetails.cardLast4})
                  </span>
                </div>
              )}
              <div className="receipt-item">
            ...
            <div className="receipt-footer">
              <p>
                Thank you for your purchase. You can now access your module in
                your training dashboard.
              </p>
              <button className="pay-button" onClick={handleReceiptClose}>
                Go to My Modules
              </button>
            </div>
          </div>
          ...
          <form className="payment-form" onSubmit={handlePayment}>
            ...
            <div className="form-section">
              ...
              <div className="form-group">
                ...
                />
                {errors.receipt && (
                  <div className="error-message">{errors.receipt}</div>
                )}
                <div className="receipt-note">
                  <small>
                    Please upload a clear image of your payment receipt (max
                    5MB)
                  </small>
                </div>
              </div>
