...
export default function QuizEditor() {
    ...
    const handleEditQuiz = (quiz) => {
        ...
        setCurrentQuiz(quiz);
        fetchQuizQuestions(quiz.quiz_id);
        ...
        try {
            ...
            if (editingQuizId) {
                ...
                response = await fetch(
                    `${API_BASE_URL}/quizzes/${editingQuizId}`,
                    {
                        method,
                        headers: {
            ...
            // Update state with the new quiz data, being careful to use quiz_id
            if (!editingQuizId) {
                setCurrentQuiz({
                    ...responseData,
    ...
    const handleDeleteQuiz = async (quizId) => {
        ...
        try {
            ...
            // Clear current quiz if it was the one deleted
            if (currentQuiz && currentQuiz.quiz_id === quizId) {
                setCurrentQuiz(null);
                setQuestionBankVisible(false);
            }
    ...
    const handleSaveAllChanges = async () => {
        try {
            ...
            const quizResponse = await fetch(
                `${API_BASE_URL}/quizzes/${currentQuiz.quiz_id}`,
                {
                    method: "PUT",
                    headers: {
                        "Content-Type": "application/json",
            ...
            await fetchQuizQuestions(currentQuiz.quiz_id);
        } catch (err) {
    ...
    const handleSaveQuestion = async () => {
        ...
        try {
            ...
            if (editingQuestionId) {
                ...
                // Create new question
                response = await fetch(
                    `${API_BASE_URL}/quizzes/${currentQuiz.quiz_id}/questions`,
                    {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json",
    ...
    const handleEditQuestion = async (questionId) => {
        try {
            ...
            if (existingQuestion.type === "true-false") {
                ...
                if (
                    !processedOptions[0].isCorrect &&
                    !processedOptions[1].isCorrect
                ) {
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                {loading ? (
                                    ...
                                    <div className="col-span-2 text-center py-10 text-gray-500">
                                        <p>
                                            No questions found in this quiz. Add
