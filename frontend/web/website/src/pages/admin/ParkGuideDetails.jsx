...
export default function ParkGuideDetails() {
  ...
  if (error || !guide)
    return (
      <div className="p-6 text-red-600">{error || "Park guide not found."}</div>
    );
    ...
    <div className="p-6 space-y-4 text-green-900">
      ...
      <div className="bg-white p-6 rounded-xl shadow-md flex gap-6 items-start border border-green-300">
        ...
        <div className="space-y-2 text-sm">
          {" "}
          <p>
            <strong>Full Name:</strong> {guide.first_name} {guide.last_name}
          </p>
          <p>
          ...
          <p>
            ...
            {guide.user_status
              ? guide.user_status.charAt(0).toUpperCase() +
                guide.user_status.slice(1)
              : ""}
          </p>
          <p>
          ...
          <p>
            <strong>Assigned Park:</strong> {guide.assigned_park || "N/A"}
          </p>
          <p>
            <strong>License Expiry:</strong>{" "}
            {guide.license_expiry_date || "N/A"}
          </p>
        </div>
      </div>
