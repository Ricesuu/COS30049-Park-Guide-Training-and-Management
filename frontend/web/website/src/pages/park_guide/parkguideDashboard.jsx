    ...
    return (
        <div className="dashboard-main-content">
            <div className="page-title-card">
                <h1>Dashboard</h1>
                <p>
                    Welcome to your park guide dashboard. Track your training
                    progress and manage your certifications.
                </p>
            </div>
            {/* User Info Container */}{" "}
                    ...
                    <div className="box certification">
                        ...
                        {certifications && certifications.length > 0 ? (
                            ...
                            <div className="no-certs-message">
                                <p>
                                    Complete training modules to earn
                                    certifications
                                </p>
                            </div>
                        )}
