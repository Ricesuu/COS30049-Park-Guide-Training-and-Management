...
const ParkguideTraining = () => {
  ...
  const renderModuleCard = (module, isPurchased = false) => {
    ...
    const isFree =
      module.price === 0 || module.price === "0" || module.price === "0.00";
    ...
    return (
      <div
        ...
        style={{
          ...
          backgroundColor: "#fff",
          opacity:
            !isPurchased && !module.is_compulsory && !hasAllCompulsoryModules
              ? 0.7
              : 1,
        }}
        onClick={(e) =>
  ...
  return (
    <div className="training-main-content">
      <div className="page-title-card">
        ...
        <p>
          Welcome to the Park Guide Training Program. These modules are designed
          to enhance your skills and knowledge as a professional park guide.
        </p>
      </div>
        ...
        >
          ...
          <button
            ...
            style={{
              padding: "8px 16px",
              backgroundColor:
                activeView === "completed" ? "#2E7D32" : "#f0f0f0",
          ...
          <button
            ...
            style={{
              padding: "8px 16px",
              backgroundColor:
                activeView === "available" ? "#2E7D32" : "#f0f0f0",
            ...
            >
              {!hasAllCompulsoryModules && (
                ...
                >
                  ...
                  <p>
                    Please complete these compulsory modules before purchasing
                    additional modules:
                  </p>
                  <ul
                    style={{
