                ...
                <div className="module-view-toggle">
                    <button
                        className={`toggle-btn ${
                            !showModuleStore ? "active" : ""
                        }`}
                        onClick={() => setShowModuleStore(false)}
                        style={{
                            padding: "8px 16px",
                            backgroundColor: !showModuleStore
                                ? "#4CAF50"
                                : "#f0f0f0",
                    ...
                    {showModuleStore ? (
                                ...
                                >
                                    {availableModules.map((module, index) => (
                                        ...
                                        >
                                            ...
                                            <div
                                                className="store-module-content"
                                                style={{ padding: "16px" }}
                                            >
                                                <h3
                                                    style={{
                        ...
                        <div className="training-module-grid">
                            ...
                            {purchasedModules.length === 0 ? (
                                <div
                                    className="no-modules-container"
                                    style={{
                                        textAlign: "center",
                                        padding: "2rem",
                                        backgroundColor: "#f9f9f9",
                                ...
                                >
                                    {purchasedModules.map((module, index) => (
                                        ...
                                        >
                                            <div
                                                className="training-module-image-container"
                                                style={{
                                                    position: "relative",
                                                    height: "160px",
                                                    overflow: "hidden",
                                            ...
                                            >
                                                ...
                                                {(module.module_status ===
                                                    ...
                                                    module.status ===
                                                        "completed") && (
                                                    <div
                                                        className="training-module-badge completed"
                                                        style={{
                                                            position:
                                                                "absolute",
                                                            top: "10px",
                                                ...
                                                {module.paymentStatus ===
                                                    "pending" && (
                                                    <div
                                                        className="training-module-badge pending"
                                                        style={{
                                                            position:
                                                                "absolute",
                                                            top: "10px",
                                                ...
                                                {module.paymentStatus ===
                                                    "rejected" && (
                                                    <div
                                                        className="training-module-badge rejected"
                                                        style={{
                                                            position:
                                                                "absolute",
                                                            top: "10px",
                                            ...
                                            >
                                                ...
                                                <p
                                                    className="training-module-description"
                                                    style={{
                                                        margin: "0 0 16px 0",
                                                        fontSize: "14px",
                                                        color: "#666",
