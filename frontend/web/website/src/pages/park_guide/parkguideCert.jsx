            ...
            >
                ...
                <div style={{ marginBottom: "2rem" }}>
                    <p style={{ color: "#4b5563", marginBottom: "1rem" }}>
                        Choose a park where you would like to be assigned. Your
    ...
    const handleLicenseApplication = async () => {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(
                    error.message || "Failed to submit license request"
                );
            }
            ...
            const updatedGuideResponse = await fetch("/api/park-guides/user", {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
    ...
    return (
        <div className="cert-main-content">
            <div className="page-title-card">
                ...
                <p>
                    View and manage your professional park guide certifications.
                    Complete training modules to earn new certifications.
                </p>
            </div>
            ...
            {isEligibleForLicense && (
                ...
                >
                    ...
                    >
                        🎉 Congratulations! You are now eligible for an official
                        park guide license.
                    </h3>
                    <p style={{ marginBottom: "1rem" }}>
                        You have completed all required training modules. You
                        can now proceed to apply for your park guide license.
                    </p>
                    <button
                        onClick={() => {
