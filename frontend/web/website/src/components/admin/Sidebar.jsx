    ...
    <div className="fixed top-0 left-0 w-64 bg-green-800 text-white h-screen p-6 space-y-6">
      ...
      <nav className="space-y-4">
        <Link to="/admin/dashboard">
          <p className="block text-white hover:text-green-300 p-4">Dashboard</p>
        </Link>
        <Link to="/admin/iot-hub">
          <p className="block text-white hover:text-green-300 p-4">IoT Hub</p>
        </Link>
        ...
        <Link to="/admin/quiz-editor">
          <p className="block text-white hover:text-green-300 p-4">Quiz Editor</p>
        </Link>
        <Link to="/admin/park-guides">
          <p className="block text-white hover:text-green-300 p-4">Park Guides</p>
        </Link>
      </nav>
    </div>
  );
