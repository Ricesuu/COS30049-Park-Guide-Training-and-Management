  ...
  const modules = [
    {
      ...
      description: "Learn essential first aid skills, including CPR and wound care.",
    ...
    },
    {
      ...
      description: "Understand how to stay safe while interacting with wildlife.",
    ...
    },
    {
      ...
      description: "Master advanced skills for park guides, including navigation and leadership.",
          ...
          {modules.map((module, index) => (
            <View key={index} style={styles.moduleItem}>
              ...
              <View style={styles.moduleDetails}>
                ...
                >
                  <Text style={styles.infoButtonText}>View Module</Text>
                </TouchableOpacity>
              </View>
            </View>
          ))}
        ...
        >
          <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
              ...
              <Text style={styles.modalText}>{selectedModule.description}</Text>
              <Video
