// app/pg-dashboard/with-layout/payment.jsx
...
import useTransactionHistoryHandler from "../../../hooks/useTransactionHistoryHandler"; // ✅ import it
...
export const Payment = () => {
  const {
    ...
    openModal,
    closeModal,
    refreshTransactions, // ✅ extract it
  ...
  return (
    <FlatList
      ...
      keyExtractor={() => "dummy"}
      ListHeaderComponent={
        <View className="flex flex-col gap-6 min-h-screen bg-white">
          {/* QR Section */}
          <LinearGradient
