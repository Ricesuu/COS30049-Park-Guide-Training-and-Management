...
const ModuleMarketplace = () => {
    ...
    useEffect(() => {
        ...
        try {
            ...
            setError("Failed to load available modules. Please try again later.");
                ...
                <View style={styles.dashboard}>
                    ...
                    {isLoading ? (
                        <View style={styles.loadingContainer}>
                            ...
                            <Text style={styles.loadingText}>Loading available modules...</Text>
                        </View>
                    ) : error ? (
                        ...
                        <View style={styles.emptyStateContainer}>
                            ...
                            <Text style={styles.emptyStateText}>
                                There are currently no modules available for purchase. Please check back later.
                            </Text>
                        </View>
                    ) : (
